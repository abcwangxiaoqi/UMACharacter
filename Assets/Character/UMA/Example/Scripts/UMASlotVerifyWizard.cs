...
namespace UMA
{
	public class UMASlotVerifyWizard : MonoBehaviour
	{
		...
		{
#if UNITY_EDITOR
			SetBaseMesh("Assets/Character/UMA/Content/UMA/Humanoid/FBX/Male/Male_Unified.fbx");
#endif
		}
		public void SelectFemaleClick()
		{
#if UNITY_EDITOR
			SetBaseMesh("Assets/Character/UMA/Content/UMA/Humanoid/FBX/Female/Female_Unified.fbx");
#endif
		}
