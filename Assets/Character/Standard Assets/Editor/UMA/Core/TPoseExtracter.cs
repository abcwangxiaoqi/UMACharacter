				...
				foreach (var selectedObject in selectedObjects)
				{
					...
					if (!string.IsNullOrEmpty(assetPath))
					{
						...
						if( modelImporter != null )
						{
							...
							if (!System.IO.Directory.Exists("Assets/Character/UMA/Assets/TPoses"))
								System.IO.Directory.CreateDirectory("Assets/Character/UMA/UMA_Assets/TPoses");
							AssetDatabase.CreateAsset(asset, "Assets/Character/UMA/UMA_Assets/TPoses/" + name + "_TPose.asset");
							extracted = true;
						}
					}
				}
