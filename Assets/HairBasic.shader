...
Shader "NineMoon/Hair/HairBasic" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_4863_if_leA = step(_MainTex_var.a,_Cutoff);
                float node_4863_if_leB = step(_Cutoff,_MainTex_var.a);
                float node_6083 = 1.0;
                clip(lerp((node_4863_if_leA*0.0)+(node_4863_if_leB*node_6083),node_6083,node_4863_if_leA*node_4863_if_leB) - 0.5);
...
/////// Diffuse:
                ...
                float3 node_5561 = (_Color.rgb*_MainTex_var.rgb);
                float3 diffuseColor = node_5561;
                float3 diffuse = (directDiffuse + indirectDiffuse) * diffuseColor;
////// Emissive:
                float3 emissive = node_5561;
/// Final Color:
