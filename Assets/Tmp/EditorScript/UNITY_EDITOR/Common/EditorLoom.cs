...
public static class EditorLoom
{
	...
	/// </value>
	public static bool AreTasksAvailable {
	...
	/// </param>
	static void Dispatch (Action function)
	{
    ...
    {
        ThreadPool.QueueUserWorkItem(Run,action);
    }

    static void Run(object action)
    {
	...
	/// </exception>
	static void Dispatch (Delegate function, params object[] arguments)
	{
#if UNITY_EDITOR
		lock (mTaskQueue) {
