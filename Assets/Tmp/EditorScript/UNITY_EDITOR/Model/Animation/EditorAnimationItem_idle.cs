...
using UnityEngine;
public class EditorAnimationItem_idle : EditorAnimationItem
{
    public EditorAnimationItem_idle(ECharacterResType type, AnimatorControllerLayer layer, EnumCharacterType _sex) : base(type,layer, _sex) { }
