...
using UnityEngine;
public class EditorAnimationItem_walk : EditorAnimationItem
{
    public EditorAnimationItem_walk(ECharacterResType type, AnimatorControllerLayer layer, EnumCharacterType _sex) : base(type,layer, _sex) { }
