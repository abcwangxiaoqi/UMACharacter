...
public static class StringExpand
{
    ...
    public static T JsonTransferObject<T>(this string str) where T : class
    {
...
{
    public static string JsonTransferString(this object obj)
    {
        return JsonMapper.ToJson(obj);
    }

    public static void RefreshShader(this Object obj)
    {
        GameObject o = obj as GameObject;
        o.RefreshShader();
    }

    public static void ClearNoUseAnimator(this Object obj)
    {
        GameObject o = obj as GameObject;
...
public static class DictionaryExpand
{
    ...
    /// 提供一个方法遍历所有key值
    /// </summary>
    public static void ForeachKey<TKey, TValue>(this Dictionary<TKey, TValue> dic, CallBackWithParamsReturn<TKey,bool> action, int maxCount = 1000)
    {
        if (action == null) return;
        var enumerator = dic.GetEnumerator();
        int i = 0;
    ...
    /// 提供一个方法遍历所有value值
    /// </summary>
    public static void ForeachValue<TKey, TValue>(this Dictionary<TKey, TValue> dic, CallBackWithParamsReturn<TValue, bool> action, int maxCount = 1000)
    {
        if (action == null) return;
        var enumerator = dic.GetEnumerator();
        int i = 0;
